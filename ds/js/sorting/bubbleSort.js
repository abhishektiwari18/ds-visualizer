...
animate(rectangle)
{
console.log("----------------------animate CHALA",rectangle)
var THIS=this;
var c1=this.centerX;
var c2=this.centerY;
...
{
console.log("diagonal me aaya",Math.round(tempRectX[i]),Math.round(tempRectY[i]));
//context.lineWidth=1;
...
rect3.xCoordinate=rect1.xCoordinate+xOffset;//200
rect3.yCoordinate=rect1.yCoordinate;
rect3.width=parseInt(this.width);
rect3.height=parseInt(this.height);
tempRect1=this.getCoordinatesList(rect3.xCoordinate,rect3.yCoordinate,rect3.xCoordinate,rect3.yCoordinate+rect3.height);
rect3.xList=tempRect1[0];
rect3.yList=tempRect1[1];
rect3.xList[rect3.xList.length]=rect3.xCoordinate
rect3.yList[rect3.yList.length]=rect3.yCoordinate+rect3.height
...
tempRect1=this.getCoordinatesList(rect4.xCoordinate,rect4.yCoordinate,rect4.xCoordinate,rect4.yCoordinate-rect4.height);
rect4.xList=tempRect1[0];
rect4.yList=tempRect1[1];

rect4.xList[rect4.xList.length]=rect4.xCoordinate
rect4.yList[rect4.yList.length]=rect4.yCoordinate-rect4.height;
rect4.direction="up";
...
console.log("rect6push-------------------------------------",rect6.xCoordinate,rect6.yCoordinate)
...
var tempX=newX+xOffset;
if(tempX>this.canvas.width)
{
console.log("if me aaya",newX,tempX,this.initialX);
this.canvas.height*=2;
newY=this.initialY+(this.numberOfElements*this.height)+20;
newX=20 //this.initialX //change
}
this.elements=x;
...
this.initialY=y;
//change
var c1=this.canvas.width-this.width    //this.canvas.width/2;
var c2=(this.canvas.height/2)                 //this.canvas.height/2;
...
shape.initializePass(20+defaultWidth+40,20);   //change
